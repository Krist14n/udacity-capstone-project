...
async function main() {
    ...
    proofs.forEach(async function (proof, index) {
        const result = await contract.methods.mintUniqueTokenTo(OWNER_ADDRESS, index, proof.proof.A, proof.proof.A_p, proof.proof.B, proof.proof.B_p, proof.proof.C, proof.proof.C_p, proof.proof.H, proof.proof.K, proof.input).send({
            from: OWNER_ADDRESS,
            gas: 3000000
        });
