...
contract Ownable {
    ...
    constructor() internal
    {
        ...
        emit OwnershipTransfered(msg.sender);
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(!Address.isContract(newOwner), "Owner must be a real address");
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "'to' is the owner of the 'tokenId'");

        // require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(_owner, msg.sender), "Operation not allowed for sender.");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "'from' is not the owner of given token");
...
contract REstXERC721Token is ERC721Metadata("Real Estate Exchange", "REstEx", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
